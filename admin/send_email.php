...
$message = '';
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['subject']) && isset($_POST['body'])) {
    ...
    if (file_exists($emailListFile)) {
        ...
        if (!empty($emails)) {
            ...
            try {
                ...
                $mail->send();
                record_sent_email($emails, $subject, $body);
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
    <h1 class="text-3xl font-bold text-gray-900 mb-8">Send Email to Subscribers</h1>
